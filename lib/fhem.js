...
//  const ws = new WebSocket(connection.base_url.replace('http','ws') + query );
//
//  ws.on('open', function open() {
//    connection.log( 'starting websocket: ' + connection.base_url.replace('http','ws') + query );
//  });
//
...
//  });
  ...
  var input = '';
  connection.log( 'waiting for restults ...' );
