  ...
  if( device.isOfType('blind') && device.mappings.TargetPosition ) {
    d.capabilities.push( {
	                   ...
	                   "capabilityResources": {
                           ...
                           "configuration": {
                             "supportedRange": {
                               "minimumValue": mappings.minValue || 0,
                               "maximumValue": mappings.maxValue || 100,
                               "precision": mappings.minStep || 1
                             },
                             ...
                             "actionMappings": [
                               {
                                 ...
                                 "directive": {
                                   "name": "SetRangeValue",
                                   "payload": {
                                     "rangeValue": mappings.minValue || 0
                                   }
                                 }
                               },
                               {
                                 ...
                                 "directive": {
                                   "name": "SetRangeValue",
                                   "payload": {
                                     "rangeValue": mappings.maxValue || 100
                                   }
                                 }
                               },
                               {
                                 ...
                                 "directive": {
                                   ...
                                   "payload": {
                                     "rangeValueDelta" : -mappings.minStep || -10,
                             ...
                             "stateMappings": [
                               {
                                 ...
                                 "value": mappings.minValue || 0
                               },
                               {
                                 "@type": "StatesToRange",
                                 "states": ["Alexa.States.Open"],
                                 "range": {
                                   "minimumValue": mappings.minValue ? mappings.minValue + 1 : 1,
                                   "maximumValue": mappings.maxValue || 100
                                 }
                               }
                             ]
